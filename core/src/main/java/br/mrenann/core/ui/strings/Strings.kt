...
data class OrdersStrings(
    ...
    val agency: String,
    val residence: String,
    val paymentAwaitingApproval: String,
    val ensureCompleteTransfer: String,
    val oneTimePayment: (String) -> String,
    val paidWith: String,
    val ensurePaymentSufficientLimit: String,
    val payYourOrderWithPix: String,
    val checkingThisForYou: String,
    val shippedTitle: String,
    val onTheRoadTitle: String,
    val dispatchedTitle: String,
    val enRouteTitle: String,
    val shippedSubtitle: String,
    val onTheRoadSubtitle: String,
    val dispatchedSubtitle: String,
    val enRouteSubtitle: String,
